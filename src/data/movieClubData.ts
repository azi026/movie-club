  ...
  vocabulary: [
    {
      ...
      definitionEn:
        "A Korean concept of fate and providence connecting souls through past incarnations",
      example:
        "Even strangers brushing shoulders in the street might have 8,000 layers of In-Yun.",
    },
    {
      term: "Bittersweet",
      ...
      example:
        "Their final goodbye at the taxi was a truly bittersweet moment.",
    },
    {
      term: "Reconnection",
      ...
      example:
        "The film captures the tender awkwardness of reconnecting after 24 years.",
    },
    {
      ...
      definitionEn:
        "The tension between what is fated to happen and what we actively decide",
      example:
        "Did they choose to drift apart, or was it simply destiny taking over?",
    },
  ],
};
...
export const PAYMENT_CONFIG = {
  ...
  cardHolderNameEn: "Hanieh Miraboulghasemi",
...
export const CURRENT_GATHERING: GatheringData = {
  ...
  dayOfWeekEn: "Sunday",
  time: "17:00",
  cafeNameFa: "کافه هاسمیک| به معنای گل یاسمن",
  cafeNameEn: "Café Hasmik",
  locationFa: "خیابان الغدیرجنوبی،غذیر 10",
  locationEn: "Valiasr St, Tehran",
  addressFa:
    "تهران، خیابان ولیعصر، نرسیده به میدان تجریش، ابتدای ولنجک، کافه لوفته",
  addressEn: "Hasmik Cafe, Ghadir 10, South Al-Ghadir, Nazarabad",
...
export const HOW_IT_WORKS_STEPS = [
  ...
  },
  {
    ...
    descFa:
      "گوش بده، نظر بده، سوال بپرس و از گفتگو لذت ببر. فشار هیچ‌جایی نیست!",
    descEn:
      "Listen, share thoughts, ask questions, or just enjoy the vibe. No pressure at all!",
    icon: "message-circle",
  },
];
...
export const BENEFITS = [
  ...
  },
  {
    ...
    descFa:
      "لازم نیست بی‌نقص حرف بزنی؛ اینجا همه برای گفتگو و تجربه کردن آمده‌اند.",
    descEn:
      "You don't need to speak perfectly; we are all here to converse and share experiences.",
    icon: "star",
  },
  {
