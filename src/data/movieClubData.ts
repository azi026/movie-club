...
export const HOW_IT_WORKS_STEPS = [
  ...
  },
  {
    ...
    descFa: `${CURRENT_GATHERING.dayOfWeekFa} ساعت ${CURRENT_GATHERING.time} در کافه دور هم جمع می‌شویم.`,
    descEn: `Meet us at the cozy café on ${CURRENT_GATHERING.dayOfWeekEn} at ${CURRENT_GATHERING.time}.`,
    icon: "coffee",
  },
  {
    stepNumber: 3,
