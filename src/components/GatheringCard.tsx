...
export const GatheringCard: React.FC<GatheringCardProps> = ({
  ...
  if (isLoading) {
    return (
      <section
        id="this-week-gathering"
        className="w-full py-8 sm:py-11 px-4 sm:px-6 lg:px-8 bg-[#121110]"
      >
        ...
        "
          >
            {/* Image placeholder */}
            <div className="h-40 sm:h-52 bg-white/5" />

            {/* Content */}
            <div className="p-5 sm:p-7">
              {/* Title */}
              <div className="h-6 w-40 bg-white/10 rounded mb-5 ml-auto" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[280px]">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="flex items-center gap-2.5 sm:gap-3 text-xs sm:text-base text-[#ded5cb]">
                  ...
                  <span className="text-xs sm:text-base">
                    {lang === "fa"
                      ? `ساعت ${getTimeDisplay("fa")}`
                      : `${t("gathering.time_label")} ${getTimeDisplay("en")}`}
                  </span>
                </div>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-1.5 text-[10px] sm:text-[11px] text-[#a39487] mt-2 sm:mt-3">
                ...
                <span>
                  {lang === "fa"
                    ? "حضور با رزرو قبلی جهت هماهنگی فضا"
                    : "Prior reservation helps us prepare the space"}
                </span>
              </div>
            </div>
          </div>
