...
const translations: Record<Language, Record<string, string>> = {
  fa: {
    ...
    "hero.reassurance_badge":
      "لازم نیست انگلیسی‌ات عالی باشه؛ فقط کافیه بخوای حرف بزنی.",
    ...
    "reassurance.footer":
      "یک جمع دوستانه و بدون قضاوت؛ فقط کافیست بخواهی تجربه کنی.",

    // Gathering Card
    "gathering.title": "دورهمی این هفته",
    "gathering.quote":
      "یک عصر صمیمی با فیلم، گفتگو و قهوه؛ جایی برای ارتباط، شنیدن دیدگاه‌های تازه و دوستان جدید.",
  ...
  en: {
    ...
    "hero.reassurance_badge":
      "You don't need perfect English; just the willingness to speak.",
    ...
    "how.subtitle":
      "Simple & stress-free: 3 steps to a relaxed social gathering",
    ...
    "reassurance.footer":
      "A welcoming, judgment-free circle where everyone participates at their own pace.",
    ...
    "gathering.small_community":
      "Our circle is kept small so everyone has a chance to speak.",
    "gathering.reserve_btn": "Reserve My Seat",
    "gathering.time_label": "Time",

    // Footer
    "footer.tagline":
      "Cinema, a delightful excuse to speak English over coffee.",
    ...
    "modal.close": "Close",
    "modal.level_newbie":
      "Newcomer — I prefer to mostly listen and ease into conversation",
    "modal.level_newbie_desc":
      "If speaking feels tough right now, no worries; feel free to listen and jump in whenever comfortable.",
    "modal.level_beginner":
      "Beginner — I speak using short and simple sentences",
    "modal.level_beginner_desc":
      "I can talk about simple topics using short phrases and sentences.",
    "modal.level_intermediate": "Intermediate — I can express my opinions",
    "modal.level_intermediate_desc":
      "I can describe the film, characters, and emotions and join conversations easily.",
    "modal.level_advanced": "Advanced — I enjoy deep conversations",
    "modal.level_advanced_desc":
      "I feel comfortable discussing complex, philosophical, and cinematic themes.",
  },
};
